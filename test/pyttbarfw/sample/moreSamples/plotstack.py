...
for istage in range(rangenum) : 
    ...
    theCanvas.Print("./plotstack_"+ str(endstring2)+ "/" + histName0 + lep + str(istage)  + instring + endstring+".pdf", "pdf")
    theCanvas.Print("./plotstack_"+ str(endstring2)+ "/" + histName0 + lep + str(istage)  + instring + endstring+".png", "png")
