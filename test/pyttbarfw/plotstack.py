...
def fillCutFlow(Nevents, hCutFlowAllstages , thestage ) : #(hcutflow1stage, hCutFlowAllstages , thestage ) :
    '''
    cutflowHisto = hcutflow1stage

    NevBin = cutflowHisto.GetXaxis().FindBin(0)
    NevPass = cutflowHisto.GetBinContent(NevBin)
    cutbin = hCutFlowAllstages.GetXaxis().FindBin(int(thestage))
    #fileOut.cd()
    hCutFlowAllstages.SetBinContent(cutbin, NevPass ) 
    '''
    cutbin = hCutFlowAllstages.GetXaxis().FindBin(int(thestage))
    hCutFlowAllstages.SetBinContent(cutbin, Nevents ) 

    return hCutFlowAllstages
...
def plotstack(argv) : 
    ...
    fileoutis = 'plotstack_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_' + options.hist + '.root'

    theOutfile = ROOT.TFile( fileoutis, "RECREATE") 

    if options.noData : print "WARNING : DATA will not be plotted !!! "
    ...
    hCutFlowData = ROOT.TH1F("hCutFlowData", " ;; Events passing cuts ", nstageBs, stageBs )
    hCutFlowMuData = ROOT.TH1F("hCutFlowMuData", " ;; Events passing cuts ", nstageBs, stageBs )
    hCutFlowElData = ROOT.TH1F("hCutFlowElData", " ;; Events passing cuts ", nstageBs, stageBs )
    hCutFlowttbar = ROOT.TH1F("hCutFlowttbar", " ;; Events passing cuts ", nstageBs, stageBs )
    hCutFlowWjets = ROOT.TH1F("hCutFlowWjets", " ;; Events passing cuts ", nstageBs, stageBs )
    hCutFlowSt = ROOT.TH1F("hCutFlowSt", " ;; Events passing cuts ", nstageBs, stageBs )
    hCutFlowQCD = ROOT.TH1F("hCutFlowQCD", " ;; Events passing cuts ", nstageBs, stageBs )
    ...
    lumi = 12300. #27220. #12300. #12900./1.618    # pb-1
    ...
    CorrIs = "_PUreweight_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages"

    if options.allMC and options.ttSF : 
        CorrIs = "_PUreweight_ttSF_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages"
    if options.allMC and options.includeQCD : 
        CorrIs = "_PUreweight_QCD_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages"
        if options.drawOnlyQCD : CorrIs = "_PUreweight_drawONLYQCD_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages"
    ...
    if options.noData : 
        ...
        if options.Type2 :
            ...
            datafile =[ ROOT.TFile('data_BCD_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root')]
    ...
    if options.Type2 :
        ...
        print "Type 1 selection"
        ttbarfile = [ROOT.TFile('ttjets_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root')]
    ...
    if options.allMC :
        if options.Type2 :
            ...
            wjetsfiles = [
                ROOT.TFile('wjets1_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                ROOT.TFile('wjets2_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                ROOT.TFile('wjets3_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                ROOT.TFile('wjets4_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                ROOT.TFile('wjets5_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                ROOT.TFile('wjets6_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                ROOT.TFile('wjets7_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                ]
        ...
        if options.Type2 :
            ...
            stfiles = [
                    ROOT.TFile('st1_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('st2_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('st3_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('st4_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('st5_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                ]
        ...
        if options.Type2 :
            ...
            QCDfiles = [
                    ROOT.TFile('QCD-2_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD-1_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD0_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD1_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD2_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD3_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD4_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD5_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD6_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD7_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD8_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root'),
                    ROOT.TFile('QCD9_outfile_mu45Trig_muMedID_MuHighPt_ak8pt500_AK4pt30_PtSmear_weightVariesWithStages_type1.root') ]
    ...
    if options.AllStages :
            c1data   = ROOT.TCanvas("c1data" , "c1data" ,1,1,745,701)
            #c1ttbar   = ROOT.TCanvas("c1ttbar" , "c1ttbar" ,0,0,745,701)
            #c1wjets   = ROOT.TCanvas("c1wjets" , "c1wjets" ,1,1,745,701)
            #c1st   = ROOT.TCanvas("c1st" , "c1st" ,1,1,745,701)
            #c1QCD   = ROOT.TCanvas("c1QCD" , "c1QCD" ,1,1,745,701)

            leg1d = ROOT.TLegend(0.44,0.4,0.7,0.84)
            #leg1t = ROOT.TLegend(0.44,0.4,0.7,0.84)
            #leg1w = ROOT.TLegend(0.44,0.4,0.7,0.84)
            #leg1s = ROOT.TLegend(0.44,0.4,0.7,0.84)
            #leg1Q = ROOT.TLegend(0.44,0.4,0.7,0.84)

            padddata = ROOT.TPad("padddata", "padddata" ,0,0,1,1)

            #paddttbar = ROOT.TPad("paddttbar", "paddttbar" ,0,0,1,1)
            #paddwjets = ROOT.TPad("paddwjets", "paddwjets" ,0,0,1,1)
            #paddst = ROOT.TPad("paddst", "paddst" ,0,0,1,1)
            #paddQCD = ROOT.TPad("paddQCD", "paddQCD" ,0,0,1,1)

            legendList = [leg1d] #, leg1t, leg1w, leg1s, leg1Q]
            sampleNamesList = ['data', 'ttbar', 'wjets', 'st', 'QCD' ]

            #c2data   = ROOT.TCanvas("c2data" , "c2data" ,1,1,745,701)
            #c2ttbar   = ROOT.TCanvas("c2ttbar" , "c2ttbar" ,0,0,745,701)
            #c2wjets   = ROOT.TCanvas("c2wjets" , "c2wjets" ,1,1,745,701)
            #c2st   = ROOT.TCanvas("c2st" , "c2st" ,1,1,745,701)
            #c2QCD   = ROOT.TCanvas("c2QCD" , "c2QCD" ,1,1,745,701)

            leg2d = ROOT.TLegend(0.54,0.4,0.7,0.84)
            #leg2t = ROOT.TLegend(0.54,0.4,0.7,0.84)
            #leg2w = ROOT.TLegend(0.54,0.4,0.7,0.84)
            #leg2s = ROOT.TLegend(0.54,0.4,0.7,0.84)
            #leg2Q = ROOT.TLegend(0.54,0.4,0.7,0.84)

            #padddata2 = ROOT.TPad("padddata2", "padddata2" ,0,0,1,1)
            #paddttbar2 = ROOT.TPad("paddttbar2", "paddttbar2" ,0,0,1,1)
            #paddwjets2 = ROOT.TPad("paddwjets2", "paddwjets2" ,0,0,1,1)
            #paddst2 = ROOT.TPad("paddst2", "paddst2" ,0,0,1,1)
            #paddQCD2 = ROOT.TPad("paddQCD2", "paddQCD2" ,0,0,1,1)

            #legendList2 = [leg2d, leg2t, leg2w, leg2s, leg2Q]
            #theHistList = [hdataHists] , httbarHists, hwjetsHists , hstHists , hQCDHists ]
            #theSampleList = [hdata, httbar, hwjets, hst, hQCD]

            if options.AllStages:

                if options.AllStagesSample == 'data1':
                    canvasNamesList1 = [c1data]
                    theHistList = [hdataHists]
                if options.AllStagesSample == 'ttbar1':
                    canvasNamesList1 = [c1ttbar]
                    theHistList = [ httbarHists ]
                if options.AllStagesSample == 'wjets1':
                    canvasNamesList1 = [c1wjets]
                    theHistList = [ hwjetsHists ]
                if options.AllStagesSample == 'st1':
                    canvasNamesList1 = [c1st]
                    theHistList = [ hstHists ]
                if options.AllStagesSample == 'QCD1':
                    canvasNamesList1 = [c1QCD]
                    theHistList = [ hQCDHists ]
                if options.AllStagesSample == 'data2':
                    canvasNamesList1 = [c1data]
                    theHistList = [hdataHists]
                if options.AllStagesSample == 'ttbar2':
                    canvasNamesList2 = [c2ttbar]
                    theHistList = [ httbarHists ]
                if options.AllStagesSample == 'wjets2':
                    canvasNamesList2 = [c2wjets]
                    theHistList = [ hwjetsHists ]
                if options.AllStagesSample == 'st2':
                    canvasNamesList2 = [c2st]
                    theHistList = [ hstHists ]
                if options.AllStagesSample == 'QCD2':
                    canvasNamesList2 = [c2QCD]
                    theHistList = [ hQCDHists ]
                if options.AllStagesSample == 'data3':
                    canvasNamesList1 = [c1data]
                    theHistList = [hdataHists]
            #canvasNamesList2 = ['c2data', 'c2ttbar', 'c2wjets', 'c2st', 'c2QCD' ]

            padNamesList1 = [padddata ] #, paddttbar, paddwjets, paddst, paddQCD ]
            padNamesList2 = ['padd2data', 'padd2ttbar', 'padd2wjets', 'padd2st', 'padd2QCD' ]
            canvasNamesList = []
            hsampleColors = [1, 2, 3, 4, 5, 6, 7, 8, 9, 20, 11,12,13,14,15,16,17, 18,19 ]
            if options.AllStagesSample == ('data1' or 'ttbar1' or 'wjets1' or 'st1' or 'QCD1' ):
                canvasNamesList = canvasNamesList1
            else:
                canvasNamesList = canvasNamesList1
                padNamesList1 = padNamesList1
                legendList = legendList
            for i, s in enumerate(canvasNamesList) :   
                #hsample =  datafile[0].Get(options.hist + str(0))

                print "sample {}".format(sampleNamesList[i])
                ROOT.gStyle.SetOptStat(000000)
                #Set multiple of maximum to scale y axis by
                y_max_scale_all = 1.618
                print "going to canvas {}".format(s)
                cdata1 = s
                cdata1.cd()
                ...
                words1.Draw()
                words2 = ROOT.TLatex(0.181,0.82225,str(sampleNamesList[i]))
                words2.SetNDC()
    ...
    for istage in xrange(options.nstages) : 
        ...
        if options.noData : 
            print "WARNING : noData option is ON !!! "
            hdata = ttbarfile[0].Get(options.hist + str(istage))
            hdata.Sumw2()
        else :
            hdata = datafile[0].Get(options.hist + str(istage))

            theOutfile.cd()
            hdatacut = datafile[0].Get( 'hCutFlow'+ str(istage))
            #hCutFlowData =  fillCutFlow( hdatacut , hCutFlowData, int(istage) )

            ### NOTE: When adding electrons also add cutflow for each lepton type - hCutFlowMuData , hCutFlowElData
        ...
        if options.allMC :
            ...
            for iwjet in xrange(len(wjetsfiles)) :
                ...
                theOutfile.cd()
                hwjetscut = wjetsfiles[iwjet].Get( 'hCutFlow'+ str(istage))
                #hCutFlowWjets =  fillCutFlow( hwjetscut , hCutFlowWjets , int(istage) )
            ...
            for ist in xrange(len(stfiles)) :
                ...
                theOutfile.cd()
                hstcut = stfiles[ist].Get( 'hCutFlow'+ str(istage))
                #hCutFlowSt =  fillCutFlow( hstcut , hCutFlowSt , int(istage) )
            ...
            if options.includeQCD :
                ...
                for iQCD in xrange(len(QCDfiles)):
                    ...
                    theOutfile.cd()
                    hQCDcut = QCDfiles[iQCD].Get( 'hCutFlow'+ str(istage))
                    #hCutFlowQCD =  fillCutFlow( hQCDcut , hCutFlowQCD , int(istage) )
        ...
        httbar = ttbarfile[0].Get(options.hist + str(istage))
        ...
        # Get Integral for cut-flow table
        theOutfile.cd()
        #httbarcut = ttbarfile[0].Get( 'hCutFlow'+ str(istage))
        Nevttbar = httbar.Integral()
        hCutFlowttbar =  fillCutFlow( Nevttbar , hCutFlowttbar , int(istage) )
        ...
        httbarHists.append( httbar )
        hwjetsHists.append( hwjets  )
        hstHists.append( hst )
        if options.includeQCD :
            hQCDHists.append( hQCD )
        ...
        if options.AllStages :
            if options.AllStagesSample == ('data1' or 'ttbar1' or 'wjets1' or 'st1' or 'QCD1' ):
                canvasNamesList = canvasNamesList1
            if options.AllStagesSample == ('data2' or 'ttbar2' or 'wjets2' or 'st2' or 'QCD2' ):
                canvasNamesList = canvasNamesList1
            if options.AllStagesSample == ('data3' or 'ttbar3' or 'wjets3' or 'st3' or 'QCD3' ):
                canvasNamesList = canvasNamesList1

            for i, s in enumerate(canvasNamesList) :   
                hsampleHists = theHistList[i]
                hsample = hsampleHists[int(istage)]
                #print "istage is {}".format(int(istage))
                if float(istage) < 10 and options.AllStagesSample == ('data1' or 'ttbar1' or 'wjets1' or 'st1' or 'QCD1' ) :
                    if float(istage) > 0. :
                        print "hsampleColors[istage] {}".format(hsampleColors[istage])
                        hsample.SetLineColor( hsampleColors[int(istage)] ) 
                        print "draw hist same " 
                        if options.AllStagesLog :
                            ROOT.gPad.SetLogy()   
                        hsample.Draw("hist same")
                        if float(istage) == 9 :
                            leg.AddEntry(hsampleHists[0] , ' stage 0: No Cuts', 'l')
                            leg.AddEntry(hsampleHists[1] , ' stage 1: Trigger', 'l')
                            leg.AddEntry(hsampleHists[2] , ' stage 2: Lepton Pt & eta', 'l')
                            leg.AddEntry(hsampleHists[3] , ' stage 3: Med Cut ID', 'l')
                            leg.AddEntry(hsampleHists[4] , ' stage 4: HighPtID', 'l')
                            leg.AddEntry(hsampleHists[5] , ' stage 5: MET', 'l')
                            leg.AddEntry(hsampleHists[6] , ' stage 6: AK4 Pt & eta', 'l')
                            leg.AddEntry(hsampleHists[7] , ' stage 7: 2D cut', 'l')
                            leg.AddEntry(hsampleHists[8] , ' stage 8: DR(lep, AK8)', 'l')
                            leg.AddEntry(hsampleHists[9] , ' stage 9: Ht lep ', 'l')
                            leg.Draw()
                            ROOT.gPad.RedrawAxis()
                            ...
                            cdata1.cd()
                            cdata1.SetSelected(cdata1)   
     

                if float(istage) > 10 and options.AllStagesSample == ('data2' or 'ttbar2' or 'wjets2' or 'st2' or 'QCD2' ) :
                    if float(istage) > 0. :
                        print "hsampleColors[istage] {}".format(hsampleColors[istage])
                        hsample.SetLineColor( hsampleColors[int(istage - 10)] ) 
                        print "draw hist same "             
                        hsample.Draw("hist same")
                        if float(istage) == 17 :
                            leg.AddEntry(hsampleHists[11] , ' stage 11: AK8 Pt and Eta', 'l')
                            leg.AddEntry(hsampleHists[12] , ' stage 12: AK4 B Disc', 'l')
                            leg.AddEntry(hsampleHists[13] , ' stage 13: AK8 SD mass', 'l')
                            leg.AddEntry(hsampleHists[14] , ' stage 14: AK8 tau32', 'l')
                            leg.AddEntry(hsampleHists[15] , ' stage 15: SD Mass of subjet 0', 'l')
                            leg.AddEntry(hsampleHists[16] , ' stage 16: tau21 of subjet 0', 'l')
                            leg.AddEntry(hsampleHists[17] , ' stage 17: B Disc of subjet 0', 'l')
                            ...
                            cdata1.cd()
                            cdata1.SetSelected(cdata1)   
                if float(istage) > 11 and options.AllStagesSample == ('data3' or 'ttbar3' or 'wjets3' or 'st3' or 'QCD3' ) :
                    if float(istage) > 0. :
                        print "hsampleColors[istage] {}".format(hsampleColors[istage])
                        hsample.SetLineColor( hsampleColors[int(istage - 11)] ) 
                        print "draw hist same "             
                        hsample.Draw("hist same")
                        if float(istage) == 17 :
                            leg.AddEntry(hsampleHists[12] , ' stage 12: AK4 B Disc', 'l')
                ...
                if float(istage) == 0. :
                        ...
                        hsample.GetXaxis().SetRangeUser(  xAxisrange[iHisto][0] , xAxisrange[iHisto][1] )
                        hsample.SetMaximum(y_max_scale_all * hsample.GetMaximum() )
                        hsample.SetMinimum(0.0001 )
                        hsample.GetYaxis().SetTitle("Events")
                        hsample.GetYaxis().SetTitleSize(0.065)
                        hsample.GetYaxis().SetTitleOffset(0.9) ## 0.7)
                        hsample.GetYaxis().SetLabelSize(0.06)

                        hsample.SetLineColor( hsampleColors[0] )

                        hsample.SetLineColor(1)
                        hsample.SetLineWidth(2)


                        hsample.GetXaxis().SetNdivisions(506)
                        hsample.GetXaxis().SetLabelFont(42)
                        #hsample.GetXaxis().SetLabelSize(0)
                        hsample.GetXaxis().SetTitleSize(0.0475)
                        hsample.GetXaxis().SetTickLength(0.045)
                        hsample.GetXaxis().SetTitleOffset(0.9)
                        hsample.GetXaxis().SetTitleFont(32)
                        hsample.GetYaxis().SetTitle("Events")
                        hsample.GetYaxis().SetNdivisions(406)
                        hsample.GetYaxis().SetLabelFont(42)
                        hsample.GetYaxis().SetLabelSize(0.03375)
                        hsample.GetYaxis().SetTitleSize(0.05125)
                        hsample.GetYaxis().SetTitleOffset(1.36)
                        hsample.GetYaxis().SetTitleFont(42)
                        hsample.GetXaxis().SetTitle(HistoTitle[iHisto]+","+ str(sampleNamesList[i]) +"at each stage ")
    ...
    if options.AllStages:
        if options.AllStagesSample == 'data1':
            c1data.cd()
            c1data.Print("./plots_Nov10All/" + options.hist + "_"+ options.AllStagesSample +"STAGES" + typeIs  + CorrIs + ".pdf", "pdf")
            padddata.cd()
            padddata.Close()
            c1data.cd()
            c1data.Close()
        if options.AllStagesSample == 'ttbar1':
            c1ttbar.cd()
            c1ttbar.Print("./plots_Nov10All/" + options.hist + "_ttbar_10LeptSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")
        if options.AllStagesSample == 'wjets1':
            c1wjets.Print("./plots_Nov10All/" + options.hist + "_wjets_10LeptSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")
        if options.AllStagesSample == 'st1':
            c1st.Print("./plots_Nov10All/" + options.hist + "_st_10LeptSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")
        if options.AllStagesSample == 'QCD1':
            c1QCD.Print("./plots_Nov10All/" + options.hist + "_QCD_10LeptSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")

        if options.AllStagesSample == 'data2':
            c1data.cd()
            c1data.Print("./plots_Nov10All/" + options.hist + "_data_7hadSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")
        if options.AllStagesSample == 'ttbar2':
            c2ttbar.cd()
            c2ttbar.Print("./plots_Nov10All/" + options.hist + "_ttbar_7hadSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")
        if options.AllStagesSample == 'wjets2':
            c2wjets.Print("./plots_Nov10All/" + options.hist + "_wjets_7hadSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")
        if options.AllStagesSample == 'st2':
            c2st.Print("./plots_Nov10All/" + options.hist + "_st_7hadSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")
        if options.AllStagesSample == 'QCD2':
            c2QCD.Print("./plots_Nov10All/" + options.hist + "_QCD_7hadSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")
        if options.AllStagesSample == 'data3':
            c1data.cd()
            c1data.Print("./plots_Nov10All/" + options.hist + "_data3_6hadSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")

            #c1ttbar.Print("./plots_Nov7All/" + options.hist + "_ttbar_10LeptSTAGES" + typeIs  + CorrIs + ".pdf", "pdf")
