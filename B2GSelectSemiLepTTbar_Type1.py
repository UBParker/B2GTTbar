...
class B2GSelectSemiLepTTbar_Type1( ) :
    ...
    def select( self ) :
        ...
        finCor1 = ROOT.TFile.Open( "./puppiCorr.root","READ")
        ...
        # This is a bad place, move this
        def CorrPUPPIMass(puppipt, puppieta, puppimraw) : #{
        ...
        self.ak8_m = CorrPUPPIMass( self.ak8Jetraw.Perp() , self.ak8Jetraw.Eta(), self.ak8Jetraw.M()  )
        self.ak8SD_m = CorrPUPPIMass( self.ak8SDJetraw.Perp() , self.ak8SDJetraw.Eta(), self.ak8SDJetraw.M()  )
        self.ak8SDsj0_m = CorrPUPPIMass( self.ak8SDJet_Subjet0raw.Perp() , self.ak8SDJet_Subjet0raw.Eta(), self.ak8SDJet_Subjet0raw.M()  )
        ...
        self.ak8SDsj0_m200 = CorrPUPPIMass( self.ak8SDJet_Subjet0M200.Perp() , self.ak8SDJet_Subjet0M200.Eta(), self.ak8SDJet_Subjet0M200.M()  )
        self.ak8SDsj0_m300 = CorrPUPPIMass( self.ak8SDJet_Subjet0M300.Perp() , self.ak8SDJet_Subjet0M300.Eta(), self.ak8SDJet_Subjet0M300.M()  )
        self.ak8SDsj0_m400 = CorrPUPPIMass( self.ak8SDJet_Subjet0M400.Perp() , self.ak8SDJet_Subjet0M400.Eta(), self.ak8SDJet_Subjet0M400.M()  )
        self.ak8SDsj0_m500 = CorrPUPPIMass( self.ak8SDJet_Subjet0M500.Perp() , self.ak8SDJet_Subjet0M500.Eta(), self.ak8SDJet_Subjet0M500.M()  )
        self.ak8SDsj0_m600 = CorrPUPPIMass( self.ak8SDJet_Subjet0M600.Perp() , self.ak8SDJet_Subjet0M600.Eta(), self.ak8SDJet_Subjet0M600.M()  )

        self.tau32 = self.tree.JetPuppiTau32[0]
        self.tau21 = self.tree.JetPuppiTau21[0]
        #if options.verbose : print 'ak8SDJet = (%6.2f,%8.3f,%8.3f,%6.2f)' % ( self.ak8SDJet.Perp(), self.ak8SDJet.Eta(), self.ak8SDJet.Phi(), self.ak8SDJet.M() )
        ...
        if not (self.ak8Jet.Perp() > 400. and abs(self.ak8Jet.Eta()) < 2.4 ) : return self.passed
        self.passed[1] = True
